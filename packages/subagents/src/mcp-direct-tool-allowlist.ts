// Vendored from pi-subagents (src/runs/shared/mcp-direct-tool-allowlist.ts).
// The only change from upstream is inlining getAgentDir/getProjectConfigDir
// (formerly imported from the pi-subagents shared/utils module) so this module
// is self-contained within @spider/subagents.
